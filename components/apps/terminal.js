...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["books", "projects", "personal-documents", "skills", "languages", "Northeastern", "interests"],
            Northeastern: ["Masters"],
            books: ["Clean Code.pdf", "Design Patterns.pdf", "System Design Interview.pdf", "Cracking the Coding Interview.pdf"],
            skills: ["Full-stack development", "React.js", "Node.js", "AWS", "Docker", "Kubernetes", "System Design"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">mihir@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        let rest = words.join(" ");
        rest = rest.trim();
        const availableCommands = "[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-mihir, todoist, trash, settings, sendmsg, snake, chat ]";
        switch (main) {
            case "cd":
            ...
            case "about-mihir":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-mihir");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: " + availableCommands;
                }
                break;
            ...
            case "chat":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("chatbot");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-mihir, todoist, trash, settings, sendmsg, snake, chat ]";
                }
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: " + availableCommands;
